...
void UOpenDoor::FindAudioComponent()
{
	...
	if (!AudioComponent)
	{
		UE_LOG(LogTemp, Error, TEXT("For Actor %s AudioComponent was not found"), *GetOwner()->GetName())
	}
}
...
void UOpenDoor::FindPressurePlate()
{
	if (!PressurePlate)
	{
		UE_LOG(LogTemp, Error, TEXT("%s has a null OpenDoor component"), *GetOwner()->GetName())
	}
}
